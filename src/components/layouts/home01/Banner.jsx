                ...
                <div className="row align-items-center justify-content-center">
                    ...
                    <div className="col-md-12 col-xl-6 col-lg-6">
                        <div className="banner-img-round mt-5 mt-lg-0 ps-5">
                            <img src={`https://imgs.search.brave.com/f8VKSm3p684466L6K0bo8cJNckOkLNjZgj_ZLdUWk1w/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzEwLzAzLzYxLzk1/LzM2MF9GXzEwMDM2/MTk1OTNfdEhvSDQy/akxWelh5RjN5Um5X/OTRsbDU4UTdhclgx/TUkuanBn`} alt="" className="img-fluid"/>
                        </div>
                    </div>
                </div>
            </div>
